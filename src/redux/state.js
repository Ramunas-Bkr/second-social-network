let state = {
    ...
    profilePage: {
        postsData: [
            ...
            { id: 2, likeCount: 5, lolCount: 87, heartCount: 0, sadCount: 0, angryCount: 125, message: `Daugiau nei 500.000 tibetiečių yra verčiami dirbti "perauklėjimo stovyklose". Viso tibete gyvena 3.18 milijono žmonių t.y. kas šeštas tibetietis yra įkalintas. Apart šitų darbo stovyklų egzistuoja koncentracijos stovyklos, kur yra kalinami 2.000.000 + žmonių (pagrinde Uigūrų tautybės žmonės, bei kitos etninės / religinės mažumos). Australijos politikai reiškia susirūpinimą ir skatina boikotuoti Žiemos Olimpines žaidynes Kinijoje, kurios numatytos 2022 metais.`},
    ...
    sideBar: {
        frends: [
           { id: 1, name: 'Bart', avatar: 'https://openpsychometrics.org/tests/characters/test-resources/pics/S/2.jpg'},
           { id: 2, name: 'Moe', avatar: 'https://i.pinimg.com/originals/dc/58/98/dc589844e576ad2778f4dffbdefc20cf.png'},
           { id: 3, name: 'Comic Book Guy', avatar: 'https://static.wikia.nocookie.net/simpsons/images/0/0d/ComicBookGuy3.gif/revision/latest/scale-to-width-down/650?cb=20111008075446'}
        ]
    }
